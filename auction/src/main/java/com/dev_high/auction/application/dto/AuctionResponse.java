...
public record AuctionResponse(String auctionId, String productName, AuctionStatus status,
  ...
  public static AuctionResponse fromEntity(Auction auction) {
    ...
    return new AuctionResponse(auction.getId(), product.getName(), auction.getStatus(),
